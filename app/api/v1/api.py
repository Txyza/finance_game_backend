...
from app.api.v1.endpoints import analytics, deposit, health, savings, store, task, user, work
...
api_router.include_router(deposit.router, dependencies=[Depends(get_current_user)])
